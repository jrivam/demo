...
namespace data.Model
{
    ...
    {
        public partial class Mapper : MapperTable<domain.Model.Empresa, data.Model.Empresa>
        {
        ...
        public Empresa(string connectionstringname, string name, string reference)
            : this(new Repository<domain.Model.Empresa, data.Model.Empresa>(new data.Model.Empresa.Mapper(), connectionstringname), name, reference)
        {
        }
...
namespace data.Query
{
    public partial class Empresa : IQueryTable, IQueryRepository<domain.Model.Empresa, data.Model.Empresa>
    {
        ...
        public virtual (Result result, data.Model.Empresa data) SelectSingle(int maxdepth = 1)
        {
            return _repository.SelectSingle(this, maxdepth);
        }
        public virtual (Result result, IEnumerable<data.Model.Empresa> datas) SelectMultiple(int maxdepth = 1, int top = 0)
        {
