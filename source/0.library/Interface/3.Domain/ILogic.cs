...
namespace library.Interface.Domain
{
                                      ...
                                      where V : IEntityState<T, U>
    {
        ...
        (Result result, V domain) Load(V domain, IEntityRepository<T, U> entityrepository);
        (Result result, V domain) Save(V domain, IEntityRepository<T, U> entityrepository);
        (Result result, V domain) Erase(V domain, IEntityRepository<T, U> entityrepository);
